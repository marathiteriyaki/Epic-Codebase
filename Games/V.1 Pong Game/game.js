...
class Pong
{
    ...
    case LEFT:
    //alert (this.ball.pos);
        this.ball.pos.x = this.ball.pos.x - this.ball.size.x / .9;
        break;
    case RIGHT:
        this.ball.pos.x = this.ball.pos.x + this.ball.size.x / .9;
        break;
    case UP:
        this.ball.pos.y = this.ball.pos.y - this.ball.size.y / .9;
        break;
    case DOWN:
        this.ball.pos.y = this.ball.pos.y + this.ball.size.y / .9;
        break;
